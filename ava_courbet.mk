...
# Inherit some common Avalanche stuff.
$(call inherit-product, vendor/avalanche/config/common_full_phone.mk)

PRODUCT_NAME := ava_courbet
...
# Avalanche Stuff
AVALANCHE_MAINTAINER := willtanoe
AVALANCHE_BUILDTYPE := OFFICIAL
